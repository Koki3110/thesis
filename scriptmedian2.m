...
for iscript=1:13
    titlename2 = ['PSO, CEC2005 F',num2str(iscript),', 10D'];
    filename5 = [rootname, num2str(iscript), extension];
    load ('-force', filename5);
    filename = ['plotmedianqpso10df', num2str(iscript), '.tif'];
    filename6 = ['plotmedianpso10df', num2str(iscript), '.tif'];
    filename2 = ['plotmeansdpso10df', num2str(iscript), '.tif'];
    filename3 = ['plotmeansepso10df', num2str(iscript), '.tif'];
    filename4 = ['plotmeanpso10df', num2str(iscript), '.tif'];
