...
filename = ["myresultspso_",num2str(D),"df",num2str(fun),"_",num2str(N),"ps.txt"];
save(filename);

%{
switch fun
    case 1
        save myresultspso10df1_2.txt;
    case 2
        save myresultspso10df2_2.txt;
    case 3
        save myresultspso10df3_2.txt;
    case 4
        save myresultspso10df4_2.txt;
    case 5
        save myresultspso10df5_2.txt;
    case 6
        save myresultspso10df6_2.txt;
    case 7
        save myresultspso10df7_2.txt;
    case 8
        save myresultspso10df8_2.txt;
    case 9
        save myresultspso10df9_2.txt;
    case 10
        save myresultspso10df10_2_2.txt;
    case 11
        save myresultspso10df11_2.txt;
    case 12
        save myresultspso30df12_changed_variables.txt;
    case 13
        save myresultspso10df13_2.txt;
    case 48
        save myresultspsoGT.txt;
    case 49
        save myresultspsoPV.txt;
    case 50
        save myresultspsoTripod.txt;
    case 51
        save myresultspsoCS.txt;
    case 52
        save myresultspsoFM.txt;
    case 53
        save myresultspsoLJ.txt;
    case 54
        save myresultspso_shifted_ackley.txt;
end
%}
