function [L,U,opt_f,err] = CEC2005get_fun_info(fun,D)
% Get the lower bound, upper bound, optimal value, and allowable error tolerance for the function index 'fun'
switch(fun) % fun from 1 to 25 are CEC'05 functions
    ...
    case {15},
     ...
     case {24},
        ...
        opt_f = 260;
     case {25},
       % LB = 2;% The search domain is different from the 
%									initialization domain for this functions
        UB = 5;
         LB = -UB; 
        opt_f = 260;
    ...
    case {54}, %Shifted Ackley
        LB = -32; UB = 32;
        opt_f = 0;

    case {55}, %Hyper-ellipsoid function
        LB = -10; UB = 10;
        opt_f = 0;
end
