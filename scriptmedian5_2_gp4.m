...
filename = ["plotmedianq",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename6 = ["plotmedian",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
#titlename = 'gbestpso_, Frequency Modulation';
filename2 = ["plotmeansd",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
...
filename3 = ["plotmeanse",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename4 = ["plotmean",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename7 = ["plotlogmeansd",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename8 = ["plotlogmeanse",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename9 = ["plotlogmean",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename10 = ["boxplot",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
