...
filename5 = ["myresultsgbestpso_",num2str(D),"df",num2str(fun),"_",num2str(N),"ps.txt"];
load ('-force', filename5);
filename = ["plotmedianqgbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename6 = ["plotmediangbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
#titlename = 'gbestpso_, Frequency Modulation';
filename2 = ["plotmeansdgbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
titlename2 = ["The global-best PSO, CEC2005 F",num2str(fun),", ",num2str(D),"D, ",num2str(N)," particles"];
filename3 = ["plotmeansegbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename4 = ["plotmeangbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename7 = ["plotlogmeansdgbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename8 = ["plotlogmeansegbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename9 = ["plotlogmeangbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename10 = ["boxplotgbestpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
