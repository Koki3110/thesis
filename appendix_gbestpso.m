...
for r=1:1:Nr
    ...
    [y new_f(r,1) FE(r), best_f_iter1(r,:)] = GBestPSO(x, f, N,D,FE_max, fun, err, LB, UB, opt_f,0);
    ys(r,:,1) = y;
    ...
    [y new_f(r,2) FE1(r), best_f_iter2(r,:)] = GBestPSO(qx, qf, N,D,FE_max, fun, err, LB, UB, opt_f, 0);
    ys(r,:,2) = y;
    ...
    [y new_f(r,3) FE2(r), best_f_iter3(r,:)] = GBestPSO(qx1, qf1, N,D,FE_max, fun, err, LB, UB, opt_f, 0);
    ys(r,:,3) = y;
...
fprintf('GBestPSO - Halton Sequence\n');
...
fprintf('GBestPSO - Sobol Sequence\n');
fprintf('Avg. fitness = %e(%e) SR = %e Avg. FEs = %e(%e)\n',
mean(new_f(:,3)),
...
filename = ["myresultsgbestpso_",num2str(D),"df",num2str(fun),"_",num2str(N),"ps.txt"];
save(filename);
