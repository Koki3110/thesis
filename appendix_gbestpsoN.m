...
filename2 = ["summarygbestpsoNg_",num2str(D),"df",num2str(fun),"_",num2str(N),"ps.txt"];
...
for r=1:1:Nr
    ...
    [y new_f(r,1) FE(r), best_f_iter1(r,:)] = GBestPSON(x, f, N,D,FE_max, fun, err, LB, UB, opt_f,0);
    ys(r,:,1) = y;
    ...
    [y new_f(r,2) FE1(r), best_f_iter2(r,:)] = GBestPSON(qx, qf, N,D,FE_max, fun, err, LB, UB, opt_f, 0);
    ys(r,:,2) = y;
    ...
    [y new_f(r,3) FE2(r), best_f_iter3(r,:)] = GBestPSON(qx1, qf1, N,D,FE_max, fun, err, LB, UB, opt_f, 0);
    ys(r,:,3) = y;
...
fprintf(fid, 'GBestpsoN - Halton Sequence\n');
fprintf(fid, 'SUC = %d\n', 100*SR1/Nr);
...
fprintf(fid, 'GBestpsoN - Sobol Sequence\n');
fprintf(fid, 'SUC = %d\n', 100*SR2/Nr);
...
fprintf('GBestpsoN - Halton Sequence\n');
fprintf('SUC = %d\n', 100*SR1/Nr);
...
fprintf('GBestpsoN - Sobol Sequence\n');
fprintf('SUC = %d\n', 100*SR2/Nr);
