...
filename = ["plotmedianqgbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename6 = ["plotmediangbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
#titlename = 'gbestpso2_, Frequency Modulation';
filename2 = ["plotmeansdgbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
titlename2 = ["The global-best PSO, CEC2005 F",num2str(fun),", ",num2str(D),"D, ",num2str(N)," particles"];
filename3 = ["plotmeansegbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename4 = ["plotmeangbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename7 = ["plotlogmeansdgbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename8 = ["plotlogmeansegbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename9 = ["plotlogmeangbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename10 = ["boxplotgbestpso2_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
