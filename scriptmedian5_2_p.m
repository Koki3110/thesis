...
filename5 = ["myresultspso_",num2str(D),"df",num2str(fun),"_",num2str(N),"ps.txt"];
load ('-force', filename5);
filename = ["plotmedianqpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename6 = ["plotmedianpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
#titlename = 'pso_, Frequency Modulation';
filename2 = ["plotmeansdpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
titlename2 = ["PSO, CEC2005 F",num2str(fun),", ",num2str(N)," particles"];
filename3 = ["plotmeansepso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename4 = ["plotmeanpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename7 = ["plotlogmeansdpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename8 = ["plotlogmeansepso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
filename9 = ["plotlogmeanpso_", num2str(D),"df",num2str(fun),"_",num2str(N),"ps.tif"];
