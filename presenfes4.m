...
%fid = fopen(['funcevalresults_2_',filename5],'a');
filename = ["funcevalresultsdata",filename5];
titlename2 = ["PSO",", ","F",num2str(fun),", ",num2str(D),"D, ",num2str(N)," particles"];
filename9 = ["barploteval2_",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.png"];
filename10 = ["barplotfit2_",name, num2str(D),"df",num2str(fun),"_",num2str(N),"ps.png"];
...
%meanall=[NaN, EVALmeanH, NaN];
%meanall=[EVALmeanU, NaN, EVALmeanS];
meanall=[EVALmeanU, EVALmeanH, NaN];
%meanall=[EVALmeanU,EVALmeanH,EVALmeanS];
%errbar=[EVALstdU/sqrt(SR),EVALstdH/sqrt(SR1),EVALstdS/sqrt(SR2)];
errbar=[EVALstdU/sqrt(SR),EVALstdH/sqrt(SR1),NaN];
%errbar=[EVALstdU/sqrt(SR),NaN,EVALstdS/sqrt(SR2)];
...
errbar=[FITstdU/sqrt(Nr-SR),FITstdH/sqrt(Nr-SR1),FITstdS/sqrt(Nr-SR2)];
